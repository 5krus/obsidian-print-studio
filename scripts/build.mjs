...
const config={entryPoints:['src/main.ts'],bundle:true,external:['obsidian','electron','@codemirror/state','@codemirror/view'],format:'cjs',platform:'node',target:'es2022',outfile:'main.js',define,minify:true};
await build(config);
