...
await Promise.all([build(config),build({entryPoints:['demo/demo.ts'],bundle:true,format:'iife',platform:'browser',target:'chrome110',outfile:'build/demo.js',define}),copyFile('demo/index.html','build/index.html'),copyFile('styles.css','build/styles.css')]);
