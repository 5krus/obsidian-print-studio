...
const files={'/test.html':['build/test.html','text/html'],'/test.js':['build/test.js','text/javascript'],'/':['build/index.html','text/html'],'/demo.js':['build/demo.js','text/javascript'],'/styles.css':['build/styles.css','text/css'],'/theme.css':['build/theme.css','text/css']};
